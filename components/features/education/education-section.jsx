    ...
    <div id="education" className="relative z-50 border-t my-12 sm:my-16 lg:my-28 border-[#25213b]">
      ...
      <div className="py-4 sm:py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                ...
                <GlowCard key={edu.id} identifier={`education-${edu.id}`}>
                  <div className="p-4 sm:p-5 relative bg-[#0b0f24]/90 rounded-xl">
                    ...
                    <div className="flex items-start gap-x-3 sm:gap-x-5 py-1 sm:py-2">
                      <div className="text-pink-500 p-2.5 sm:p-3 rounded-xl bg-pink-500/10 border border-pink-500/20 shadow-[0_0_15px_rgba(236,72,153,0.2)] transition-all duration-300 hover:scale-110 hover:text-[#16f2b3] flex-shrink-0">
          ...
          <Reveal direction="left" className="order-1 lg:order-2 flex justify-center items-center">
